...
import { ShoppingBag, Star, Eye, Check, Zap, ShieldCheck, Sparkles, ExternalLink } from 'lucide-react';
        ...
        <div className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
          ...
          {product.paymentUrl && (
            <span
              ...
              className="bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold px-3 py-1.5 rounded-lg shadow-sm flex items-center gap-1.5"
            >
        ...
        <div className="pt-2.5 border-t border-zinc-100 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button
              onClick={handleDirectBuy}
              disabled={isOutOfStock}
              className="px-2.5 py-2 bg-[#121212] hover:bg-zinc-800 text-white rounded-lg text-xs font-semibold flex items-center gap-1 shadow-xs transition cursor-pointer"
              title="Güvenli Ödeme ile Satın Al"
            >
